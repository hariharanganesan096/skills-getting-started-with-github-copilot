...
activities = {
    ...
    "Soccer Team": {
        "description": "Team sport focused on soccer drills, practices, and matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["lucas@mergington.edu", "mia@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training, endurance workouts, and water safety",
    ...
    "Drama Club": {
        "description": "Practice acting, improvisation, and stage production skills",
